...
void elegirRol()
{
  ...
  do
  {
    ...
    gotoxy(15, 5);
    cout << "! B I E N V E N I D O    A    F I S I    P E T S !";
    gotoxy(30, 9);
    cout << "-- ELEGIR ACCION --";
    gotoxy(3, 11);
    cout << "[1] Dar en adopcion";
    gotoxy(3, 12);
    cout << "[2] Adoptar una mascota";
    gotoxy(3, 13);
    cout << "[3] Voluntarios";
    gotoxy(3, 15);
    cout << "[0] Salir";
    ...
    {
      gotoxy(3, 19);
      cout << "Opcion invalida. Presione una tecla para elegir otra opcion. ";
      getch();
    }
  ...
  case '3':
  {
    ...
    dibujarRectangulo(3, 3, 76, 7);
    gotoxy(30, 5);
    cout << "V O L U N T A R I O S";
    gotoxy(3, 9);
    cout << "[1] Inscribir voluntarios";
    gotoxy(3, 10);
    cout << "[2] Lista de voluntarios";
    gotoxy(3, 11);
    cout << "[3] Regresar";
    gotoxy(3, 13);
    cout << "Ingresar Opcion: ";
...
void menuDarAdopcion()
{
  ...
  do
  {
    ...
    dibujarRectangulo(3, 3, 76, 7);
    gotoxy(25, 5);
    cout << "D A R   E N   A D O P C I O N";
    gotoxy(3, 10);
    cout << "[1] Perro";
    gotoxy(3, 11);
    cout << "[2] Gato";
...
void reclutar()
{
  ...
  do
  {
    ...
    dibujarRectangulo(3, 3, 76, 7);
    gotoxy(20, 5);
    cout << "F O R M U L A R I O   D E   I N S C R I P C I O N";
    ...
    do
    {
      ...
      {
        gotoxy(40, 13);
        cout << "El numero de DNI debe tener 8 numeros.";
        Sleep(1000);
        gotoxy(40, 13);
        cout << "                                      ";
      }
    ...
    do
    {
      ...
      {
        gotoxy(3, 15);
        cout << "Digite un correo valido por favor.";
        Sleep(1000);
        gotoxy(3, 15);
        cout << "                                     ";
      }
    ...
    do
    {
      ...
      {
        gotoxy(3, 17);
        cout << "El numero de celular debe tener 9 digitos.";
        Sleep(1000);
        gotoxy(3, 17);
        cout << "                                            ";
      }
    ...
    gotoxy(3, 20);
    cout << "[1] Ingresar los datos de otro voluntario";
    gotoxy(3, 21);
...
void ingresar(string tipo)
{
  ...
  do
  {
    ...
    dibujarRectangulo(3, 3, 76, 7);
    gotoxy(25, 5);
    cout << "I N G R E S O   DE   " << text;

    mascota.codigo = 1000 + rand() % (2001 - 1000);

    gotoxy(3, 9);
    cout << "Codigo: " << mascota.codigo;
    ...
    gotoxy(3, 11);
    cout << "Fecha de ingreso: " << asctime(localtm);
    ...
    cout << "Que desea hacer ahora?";
    gotoxy(3, 18);
    cout << "[1] Ingresar los datos de otro " << tipo;
    gotoxy(3, 19);
    cout << "[2] Ir al menu principal";
    gotoxy(3, 21);
    cout << "Ingresar Opcion: ";
...
void listarMascotas(string tipo)
{
  ...
  dibujarRectangulo(3, 3, 76, 7);
  gotoxy(25, 5);
  cout << "L I S T A   DE   " << text;

  archivo >> mascota.codigo;
  if (!mascota.codigo)
  {
    gotoxy(3, 9);
    cout << "Aun no hay " << tipo << "s en el albergue." << endl
         << endl;
    gotoxy(3, 11);
    system("pause");
    elegirRol();
  ...
  while (!archivo.eof())
  {
    ...
    if (mascota.tipo == tipo)
    {
      ...
      cout << mascota.raza;
      gotoxy(36, y);
      cout << outputString(mascota.distrito);
      gotoxy(60, y);
      cout << mascota.sexo;
      gotoxy(68, y);
      cout << mascota.edad;
...
void modificar(string tipo)
{
  ...
  dibujarRectangulo(3, 3, 76, 7);
  gotoxy(25, 5);
  cout << "M O D I F I C A R   M A S C O T A";
  ...
  while (!archivo.eof())
  {
    ...
    if (mascota.tipo == tipo && mascota.codigo == codigo)
    {
      ...
      gotoxy(3, 9);
      cout << "/// Datos del " << tipo << " a modificar ///";
      gotoxy(3, 11);
      cout << "Codigo:            " << mascota.codigo;
      gotoxy(3, 12);
      cout << "Nombre:            " << mascota.nombre;
      gotoxy(3, 13);
      cout << "Fecha de ingreso:  " << mascota.fecha;
      gotoxy(3, 14);
      cout << "Raza:              " << mascota.raza;
      gotoxy(3, 15);
      cout << "Distrito:          " << mascota.distrito;
      gotoxy(3, 16);
      cout << "Sexo: 		         " << mascota.sexo;
      gotoxy(3, 17);
      cout << "Edad:              " << mascota.edad;
      ...
      gotoxy(3, 19);
      cout << "Ingrese un nuevo codigo o 0 para no modificar: ";
      cin >> N.nCodigo;
      ...
      gotoxy(3, 20);
      cout << "Ingrese un nuevo nombre o 'f' para no modificar: ";
      getline(cin, N.nNombre);
      fflush(stdin);

      if (N.nNombre == "f" || N.nNombre == "F")
        N.nNombre = mascota.nombre;

      N.nFecha = mascota.fecha;

      gotoxy(3, 21);
      cout << "Ingrese la nueva raza o 'f' para no modificar: ";
      getline(cin, N.nRaza);
      fflush(stdin);

      if (N.nRaza == "f" || N.nRaza == "F")
        N.nRaza = mascota.raza;

      gotoxy(3, 22);
      cout << "Ingrese el nuevo distrito o 'f' para no modificar: ";
      getline(cin, N.nDistrito);
      fflush(stdin);

      if (N.nDistrito == "f" || N.nDistrito == "F")
        N.nDistrito = mascota.distrito;

      gotoxy(3, 23);
      cout << "Ingrese el nuevo sexo o 'f' para no modificar: ";
      getline(cin, N.nSexo);
      fflush(stdin);

      if (N.nSexo == "f" || N.nSexo == "F")
        N.nSexo = mascota.sexo;

      gotoxy(3, 24);
      cout << "Ingrese la nueva edad o 0 para no modificar: ";
      cin >> N.nEdad;

      if (N.nEdad == 0)
        N.nEdad = mascota.codigo;
  ...
  {
    gotoxy(3, 9);
    cout << "El " << tipo << " con codigo " << codigo << " no se encuentra en el albergue.";
  }
...
void adopcion()
{
  ...
  do
  {
    ...
    dibujarRectangulo(3, 3, 76, 7);
    gotoxy(25, 5);
    cout << "A D O P T A R   U N A   M A S C O T A";
    gotoxy(3, 9);
    cout << "Elija el tipo de mascota que desee adoptar: ";
    gotoxy(3, 11);
    cout << "[1] Perro" << endl;
    gotoxy(3, 12);
    cout << "[2] Gato" << endl;
  ...
  while (!archivo.eof())
  {
    ...
    if (mascota.tipo == tipo && mascota.codigo == codigo)
    {
      ...
      {
        gotoxy(3, 9);
        cout << "Estado:             No factible para dar en adopcion";
      }
      else
      {
        gotoxy(3, 9);
        cout << "Estado:             Factible de dar en adopcion";
      }
      ...
      dibujarRectangulo(1, 25, 78, 29);
      do
      {
        gotoxy(3, 26);
        cout << "Desea adoptar la mascota? (S)i/(N)o: ";
        cin >> opAdoptar;
      ...
      if (opAdoptar == 's' || opAdoptar == 'S')
      {
        ...
        Sleep(700);
        gotoxy(3, 26);
        cout << "MASCOTA ADOPTADA CORRECTAMETE !";
      }
      else
      {
        char otraMascota;
        do
        {
          ...
          cout << "                                        ";
          gotoxy(3, 26);
          cout << "Desea adoptar otra mascota? (S)i/(N)o: ";
          cin >> otraMascota;
...
char menuAdoptar(string tipo)
{
  ...
  do
  {
    ...
    dibujarRectangulo(3, 3, 76, 7);
    gotoxy(25, 5);
    cout << "M E N U   D E   " << text;
    gotoxy(3, 9);
    cout << "[1] Agregar";
    gotoxy(3, 10);
    cout << "[2] Modificar";
    gotoxy(3, 11);
    cout << "[3] Ver " << tipo << "s del albergue";
    gotoxy(3, 13);
    cout << "Ingrese opcion: ";
    cin >> opcion;
...
void listarVoluntarios()
{
  ...
  dibujarRectangulo(3, 3, 76, 7);
  gotoxy(25, 5);
  cout << "L I S T A   D E   V O L U N T A R I O S";
